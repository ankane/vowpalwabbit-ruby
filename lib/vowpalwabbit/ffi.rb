module VowpalWabbit
  module FFI
    ...
    extern "VW_HANDLE VW_CALLING_CONV VW_InitializeA(const char* pstrArgs)"
    extern "VW_HANDLE VW_CALLING_CONV VW_InitializeWithModel(const char* pstrArgs, const char* modelData, size_t modelDataSize)"
    extern "VW_HANDLE VW_CALLING_CONV VW_SeedWithModel(VW_HANDLE handle, const char* extraArgs)"
    extern "void VW_CALLING_CONV VW_Finish_Passes(VW_HANDLE handle)"
    extern "void VW_CALLING_CONV VW_Finish(VW_HANDLE handle)"
    extern "VW_EXAMPLE VW_CALLING_CONV VW_ImportExample(VW_HANDLE handle, const char* label, VW_FEATURE_SPACE features, size_t len)"
    ...
    extern "VW_EXAMPLE VW_CALLING_CONV VW_ReadExampleA(VW_HANDLE handle, const char* line)"
    ...
    extern "const char* VW_CALLING_CONV VW_GetTag(VW_EXAMPLE e)"
    extern "size_t VW_CALLING_CONV VW_GetFeatureNumber(VW_EXAMPLE e)"
    extern "float VW_CALLING_CONV VW_GetConfidence(VW_EXAMPLE e)"
    extern "size_t VW_CALLING_CONV VW_SetFeatureSpace(VW_HANDLE handle, VW_FEATURE_SPACE feature_space, const char* name)"
    ...
    extern "size_t VW_CALLING_CONV VW_HashSpaceA(VW_HANDLE handle, const char* s)"
    extern "size_t VW_CALLING_CONV VW_HashSpaceStaticA(const char* s, const char* h)"
    extern "size_t VW_CALLING_CONV VW_HashFeatureA(VW_HANDLE handle, const char* s, size_t u)"
    extern "size_t VW_CALLING_CONV VW_HashFeatureStaticA(const char* s, size_t u, const char* h, unsigned int num_bits)"
